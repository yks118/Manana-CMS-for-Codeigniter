		...
		<li class="container-fluid">
			<ul class="list-inline list-table-td row">
				...
				<li class="col-xs-3 col-sm-3 col-md-2 col-lg-2 text-center">
					<a class="btn btn-primary btn-xs" target="_self" href="<?php echo base_url('/admin/page/update/'.$row['page_id'].'/'); ?>"><?php echo lang('text_update'); ?></a>
					<button type="button" class="btn btn-danger btn-xs" onclick="clickPageDelete(<?php echo $row['page_id']; ?>)"><?php echo lang('text_delete'); ?></button>
				</li>
			</ul>
		</li>
			<?php }
